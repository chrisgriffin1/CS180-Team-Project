...
public class Reservation implements ReservationGuide, Serializable {
    private String day;
    private double time;
    private Table table;
    ...
    // method below checks to see if table given as input is occupied - returns true
    // if occupied and false if not occupied
